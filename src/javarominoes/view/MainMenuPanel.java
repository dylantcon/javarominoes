...
public final class MainMenuPanel extends MenuPanel {
  ...
  public MainMenuPanel() {
    ...
    playButton = super.buildMenuButton(PLAY_TEXT, Color.GREEN, Color.BLUE);
    exitToDesktopButton = super.buildMenuButton(EXIT_DESKTOP_TEXT, Color.WHITE, Color.RED);
  ...
  protected void initGbl() {
    super.gblAdd(titleLabel, 0, 0, 1.0, 0.0, GridBagConstraints.CENTER, HEADER_P);
    super.gblAdd(subtitleLabel, 0, 1, 1.0, 0.0, GridBagConstraints.CENTER, HEADER_P);
    super.gblAdd(new JLabel(), 0, 2, 0.5, 0.0, GridBagConstraints.CENTER, STD_P);
    super.gblAdd(playButton, 0, 3, 0.0, 0.0, GridBagConstraints.CENTER, STD_P);
    super.gblAdd(exitToDesktopButton, 0, 4, 0.0, 0.0, GridBagConstraints.CENTER, STD_P);
    super.gblAdd(new JLabel(), 0, 5, 0.5, 0.0, GridBagConstraints.CENTER, STD_P);
    super.gblAdd(super.constructAudioPanel(), 0, 6, 0.0, 0.0, GridBagConstraints.CENTER, STD_P);
  }
