...
public class Track {
  ...
  public Track withDefaults(double volume, double duty) {
    this.defaultVolume = volume;
    this.defaultDuty = duty;
    return this;
  }

  public Track add(Note n) { notes.add(n); return this; }
  
  /**
   * add notes as alternating (midi, duration) pairs.
   * Use -1 for midi to encode a rest.
   * 
   * @author dylan
